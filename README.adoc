...
There are other reasons to upgrade than purely new functionality, such as the reduced initial heap size, pinning prevention, Unicode 17, security updates, and so on.

Additionally, a notable issue where inner classes of type parameters were being emitted as raw types has been resolved (JDK-8357653).

It is always nice to benefit from these free enhancements.
