...
Java 26 will be released on the 17th of March 2026, and once again, it helps move the language forward.

[NOTE]
.Teaser of enhancements
====
Java 26, which is a Short-Term Support release (until September 2026), gathers ten JEPs across different areas that will enhance performance, security, and modern protocol support, all while steadily progressing major, long-term language projects.
