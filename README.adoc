...
The default initial heap size has been reduced, which can lead to lower
memory footprint for applications that don't require large heaps. This
particularly benefits containerized applications and microservices.
