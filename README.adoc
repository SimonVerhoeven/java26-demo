...
The default initial heap size has been reduced when neither `Xms` nor `-XX:InitialRAMPercentage` has been used. Prior to this release the heap was set to 1/64th of the physical RAM by default, as of this release this has been changed to 1/500th. To put this into context, on a 32 GiB this resulted in a 512 MiB heap, whereas as of this release it will be 64 MiB.
